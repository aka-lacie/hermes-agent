...
class HermesCLI(CLIAgentSetupMixin, CLICommandsMixin, CLIBillingMixin):
    ...
    # Kept temporarily as a reference for the local timestamp-resume patch.
    # Runtime setup now comes from CLIAgentSetupMixin._init_agent.
    def _legacy_init_agent_pre_mixin(self, *, model_override: str = None, runtime_override: dict = None, request_overrides: dict | None = None) -> bool:
        """
