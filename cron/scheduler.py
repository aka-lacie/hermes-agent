...
def _deliver_result(job: dict, content: str) -> None:
    ...
    coro = _send_to_platform(platform, pconfig, chat_id, wrapped, thread_id=thread_id, media_files=media_files)
    try:
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=1) as pool:
            future = pool.submit(asyncio.run, _send_to_platform(platform, pconfig, chat_id, wrapped, thread_id=thread_id, media_files=media_files))
