...
def run_conversation(
    ...
    _ctx = build_turn_context(
        ...
        build_current_time_user_context=_build_current_time_user_context,
    ...
    _current_time_user_context = _ctx.current_time_user_context
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        sanitize_tool_calls = agent._should_sanitize_tool_calls()
        tool_name_by_id = {}
        for _msg in messages:
            ...
            for _tc in _msg.get("tool_calls") or []:
                ...
                _cid = _ra().AIAgent._get_tool_call_id_static(_tc)
                if _cid and _name:
        ...
        for idx, msg in enumerate(messages):
            ...
            if msg.get("role") == "tool":
                ...
                if _tool_name == "browser_screenshot":
                    _followup = agent._build_browser_screenshot_api_followup(msg.get("content"))
                    if _followup:
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                if agent._request_dump_enabled():
